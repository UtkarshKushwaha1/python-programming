...
surface = pygame.Surface((canvas_width, canvas_height)) # Making a surface to make the waves without refreshing the screen
surface.fill(black) # Filling the surface with a background

time_rate = 0.03 # The speed of rotations
...
while run:
    clock.tick(120) # Running the game at 60 fps
    ...
    for i in range(limit):
        ...
        pygame.draw.line(win, bright_white, (prevx, prevy), (x, y), 3) 
    ...
    pygame.draw.line(win, bright_white, (x, y), (350, wave[0]+pos_circle_y)) # Line between last inner circle with the wave
